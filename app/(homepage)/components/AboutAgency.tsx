      ...
      <div className="default-container">
        <div className="flex flex-col justify-center items-center xl:flex-row gap-y-10 xl:gap-y-0 xl:gap-x-5">
          ...
          <div className="order-1 xl:order-2 basis-1/2 text-center xl:text-left">
            ...
            <p className="text-lg font-normal text-[#6e6e6e] py-[15px]">
            ...
            <p className="text-lg font-normal italic text-[#6e6e6e] pb-[15px]">
            ...
            <button className="button-primary !font-semibold">Contact Us</button>
          </div>
        </div>
      </div>
